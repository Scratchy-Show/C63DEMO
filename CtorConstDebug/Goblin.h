...
public:
	...
	//const string&: retourne une REFERENCE (et non une copie) de la string. La string ne peut pas être modifiée
	// grâce au const. Autrement, ça reviendrait à modifier la string de l'instance de l'extèrieur ce qui n'est
	//pas idéal
